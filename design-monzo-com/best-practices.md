...
|---|---|---|
| 1 | Hero — emotional hook + core value prop | Product Hero |
| 2 | Social proof — immediate credibility | Customer Count & Trustpilot, trust cue strip |
| 3–5 | Feature showcase — visual storytelling | Cards Carousel, Feature Highlights, Feature Card Highlights |
| 5–7 | Rational proof — comparison, how-it-works | Feature or Product Comparison, Progressive Content |
| 7–9 | Trust reinforcement + objection handling | Media Text Block (awards), FAQ, UI Spotlight |
